...
//
// ── ACTIVATION ──────────────────────────────────────────────────────────────
// CLARITY_PROJECT_ID below is the APPROVED Clarity project ID for
...
// If it is ever cleared, this file becomes a complete no-op — no Clarity
// script, cookies, or network requests. Never commit a guessed ID.
(function () {
  'use strict';

  var CLARITY_PROJECT_ID = 'xp1ei7i9jz';
